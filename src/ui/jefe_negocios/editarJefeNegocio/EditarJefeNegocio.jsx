...
// Importamos el formulario específico (creado arriba)
import DatosJefeNegocioForm from 'components/Shared/Formularios/DatosForm';
...
const EditarJefeNegocio = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Desestructuramos la respuesta incluyendo la relación 'sede'
        ...
        // Preparamos el nombre para el buscador de sedes
        if (sede && sede.nombre) {
  ...
  // Manejador del cambio de Sede (recibe ID directo del componente SedeSearchSelect)
  const handleSedeChange = (newSedeId) => {
      setFormData(prev => ({
          ...prev,
          jefe_negocio: { ...prev.jefe_negocio, sede_id: newSedeId }
      }));
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => navigate('/personal/listar-jefes-negocio'), 1500);
    } catch (err) {
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <PageHeader 
        ...
        buttonLink="/personal/listar-jefes-negocio"
      />
            ...
            <div className="lg:col-span-1">
                <div className="bg-white p-6 rounded-xl shadow-lg border border-slate-100 border-t-4 border-slate-400 sticky top-6">
                    <div className="flex items-center gap-2 mb-6 border-b pb-2">
                        ...
                        <h2 className="text-xl font-black text-slate-700">Cuenta de Acceso</h2>
                    </div>
                    
                    <CuentaForm 
                        data={formData.jefe_negocio} 
                        handleChange={(e) => handleChange(e, 'jefe_negocio')} 
                        isEdit={true} 
                    />
                    ...
                    <div className="mt-8 pt-6 border-t border-slate-100 flex flex-col gap-3">
                        ...
                        <button 
                            type="button" 
                            onClick={() => navigate('/personal/listar-jefes-negocio')} 
